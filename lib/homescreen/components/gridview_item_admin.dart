import 'package:xeplich/arrangement_admin/schedule.dart';
  ...
  goDetailPage(BuildContext context, int index){
    switch (index){
      ...
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => MessengerUI(sender_uid: 'admin')),
        );
        break;
      case 3:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Post(uid: 'admin', email: 'admin@gmail.com',)),
        );
        break;
      case 4:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Note(uid: 'admin')),
        );
        break;
    }
  }
