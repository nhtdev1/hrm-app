...
class ScheduleAdmin extends StatefulWidget {
  ...
  const ScheduleAdmin({Key? key}) : super(key: key);
  @override
  _Schedule createState() => _Schedule();
}

class _Schedule extends State<ScheduleAdmin> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          HeaderScheduleAdmin(size, themeData),
          StreamBuilder(
  ...
  Container HeaderScheduleAdmin(Size size, ThemeData themeData) {
    return Container(
