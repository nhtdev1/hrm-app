...
class HomeScreenStaff extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuItem> menuItem = [
      MenuItem(
          title: 'Xem Lịch',
          subTitle: 'Lịch làm của tuần này',
          imgBgr: 'assets/img3.jpg'),
      MenuItem(
          title: 'Quản Lý Lịch',
          subTitle: 'Đăng ký lịch rảnh mỗi tuần',
          imgBgr: 'assets/img4.png'),
      MenuItem(
          title: 'Tin Nhắn',
          subTitle: 'Trao đổi với admin và các thành viên khác',
          imgBgr: 'assets/img9.png'),
      MenuItem(
          title: 'Bài Đăng',
          subTitle: 'Xem và chia sẻ công khai các bài viết',
          imgBgr: 'assets/img5.jpg'),
      MenuItem(
          title: 'Ghi Chú',
          subTitle: 'Xem và tạo các ghi chú',
          imgBgr: 'assets/img10.jpg'),
    ];
